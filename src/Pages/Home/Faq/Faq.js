...
const Faq = () => {
    return (
        <div className='lg:mt-10 mt-0'>
            <h1 className="text-center lg:text-3xl font-semibold lg:pb-10 pb-5  tracking-tight text-gray-900 text-[20px]"
            ...
            <div className="space-y-4">
                ...
                >
                    ...
                    <p className="mt-4 leading-relaxed text-gray-700">
                        ২০০ ml Natural Hair Oil এর দাম ৭৯৯ টাকা। ডেলিভারি চার্জ ঢাকার ভেতর ৭০ টাকা। ঢাকার বাইরে 130 টাকা। ৪০০ মিলি. অর্থাৎ ২ বোতল নিলে ডেলিভারি চার্জ ফ্রি। সেক্ষেত্রে 1600 টাকা দিলেই হবে। হোম ডেলিভারিতে প্রোডাক্ট হাতে পাবার পর টাকা দিয়ে নিতে পারবেন। অর্ডার করতে আপনার বিস্তারিত লিখে নীচের ফর্মটি পূরণ করুন। 2-3 দিনের মধ্যে ডেলিভারি পাবেন।
                    </p>
                </details>
